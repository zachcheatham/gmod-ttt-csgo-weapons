local FLASH_INTENSITY = 2550; --the higher the number, the longer the flash will be whitening your screen
...
function ENT:Initialize()
	self.Entity:SetModel("models/weapons/tfa_csgo/w_flash.mdl")
