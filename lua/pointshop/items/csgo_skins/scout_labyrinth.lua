...
ITEM.CSGOSkinMaterial = {"models/tfa_csgo/clocktic_reskinpack_scout/scout_labyrinth", "models/tfa_csgo/clocktic_reskinpack_scout/scout_labyrinthscope"}
