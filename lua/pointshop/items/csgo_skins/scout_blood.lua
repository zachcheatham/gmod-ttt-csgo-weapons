ITEM.Name = "Scout | Blood in the Water"
ITEM.Price = 2000
...
ITEM.CSGOSkinMaterial = {"models/tfa_csgo/clocktic_reskinpack_scout/scout_blood", "models/tfa_csgo/clocktic_reskinpack_scout/scout_bloodscope"}
