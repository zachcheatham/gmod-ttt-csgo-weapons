...
ITEM.CSGOSkinMaterial = {"models/tfa_csgo/clocktic_reskinpack_scout/scout_slaughter", "models/tfa_csgo/clocktic_reskinpack_scout/scout_slaughterscope"}
